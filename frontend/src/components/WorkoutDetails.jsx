                ...
                <div>
                    ...
                    <div className="flex flex-wrap gap-2.5 justify-between">
                        ...
                        <div className="flex mr-3">
                            ...
                            {/* cancel button */}
                            <svg onClick={() => { setIsEditing(false) }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="p-1 rounded-full bg-gray-300 text-white hover:bg-gray-400 active:bg-gray-300 mr-2 size-10">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <div className="flex justify-end space-x-4 mt-4">
                            <button
                                ...
                                className="px-4 py-2 bg-gray-300 hover:bg-gray-400 active:bg-gray-300 rounded-lg"
                            >
                                Cancel
                            </button>
                            <button
