...
transition-colors duration-200 py-10" disabled={isLoading}>
                <h2 className="text-2xl font-bold text-blue-600 dark:text-darkTextPrimary mb-8 transition-colors duration-200">Sign up</h2>
                <div className="flex flex-col gap-2">
                    <div className="relative min-w-sm">
                        <input type="email" placeholder="Email" value={email} onChange={handleOnChangeEmail} autoComplete="email" className="w-full p-2 mb-4 border rounded-lg placeholder:text-gray-500 dark:placeholder:text-darkTextPlaceholder dark:bg-darkInputBackground transition-colors duration-200" />
                    ...
                    <div className="relative min-w-sm ">
                        <input type={showPassword ? "text" : "password"} placeholder="Password" value={password} onChange={handleOnChangePassword} autoComplete="current-password" className="w-full p-2 border  rounded-lg placeholder:text-gray-500 dark:placeholder:text-darkTextPlaceholder dark:bg-darkInputBackground transition-colors duration-200" />
