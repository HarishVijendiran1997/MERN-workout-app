            ...
            <form onSubmit={handleSubmit} className={signupFormStyle} disabled={isLoading}>
                ...
                <div className="flex flex-col gap-2">
                    <div className="relative min-w-sm">
                        <input type="text" placeholder="Full Name" name="FullName" value={fullName} onChange={handleOnChangeFullName} autoComplete="name" className={emailStyle} />
                    ...
                    <div className="relative min-w-sm">
                        <input type="text" placeholder="Username" name="Username" value={username} onChange={handleOnChangeUsername} autoComplete="off" className={emailStyle} />
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={emailIconStyle}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                        </svg>
                    </div>
                    <div className="relative min-w-sm">
                        <input type="email" placeholder="Email" name="Email" value={email} onChange={handleOnChangeEmail} autoComplete="off" className={emailStyle} />
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={emailIconStyle}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                        </svg>
                    </div>
                    <div className="relative min-w-sm ">
                        <input type={showPassword ? "text" : "password"} name="password" placeholder="Password" value={password} onChange={handleOnChangePassword} autoComplete="new-password" className={passwordStyle} />
                    ...
                    <div className="relative min-w-sm mt-4 ">
                        <input type={showPassword ? "text" : "password"} name="confirmPassword" placeholder="Confirm Password" value={confirmPassword} onChange={handleOnChangeConfirmPassword} autoComplete="off" className={passwordStyle} />
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={passwordIconStyle}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
                        </svg>
                    </div>
