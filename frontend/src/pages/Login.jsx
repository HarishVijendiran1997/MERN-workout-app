            ...
            <form onSubmit={handleSubmit} className={loginFormStyle} disabled={isLoading}>
                ...
                <div className="flex flex-col gap-2">
                    <div className="relative min-w-sm">
                        <input name="email" type="email" placeholder="Email" value={email} onChange={handleOnChangeEmail} autoComplete="email" className={emailStyle} />
                    ...
                    <div className="relative min-w-sm ">
                        <input name="password" type={showPassword ? "text" : "password"} placeholder="Password" value={password} onChange={handleOnChangePassword} autoComplete="current-password" className={passwordStyle} />
